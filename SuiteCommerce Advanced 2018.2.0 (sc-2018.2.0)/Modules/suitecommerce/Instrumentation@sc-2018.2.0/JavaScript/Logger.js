...
define('Logger', ['Url', 'jQuery'], function(Url, $){
    ...
    function Logger() {
        ...
        var queueErrorTemp = [], queueInfoTemp = [];
        var isWaiting  = false;
        ...
        function sendQueues(isAsync) {
            ...
            var URL = parsedURL.schema + '://' + parsedURL.netLoc + '/app/site/hosting/scriptlet.nl?script=customscript_' + product.toLowerCase() + '_loggerendpoint&deploy=customdeploy_' + product.toLowerCase() + '_loggerendpoint';
