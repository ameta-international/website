			...
			<div class="cart-summary-subtotal">
				<p class="cart-summary-grid-float">
					<span class="cart-summary-amount-subtotal">
						...
						{{#if isSingleItem}}
							{{translate '<span class="cart-summary-item-quantity-subtotal">Subtotal ($(0) item)</span>'itemCount}}
						{{else}}
							{{translate '<span class="cart-summary-item-quantity-subtotal">Subtotal ($(0) items)</span>' itemCount}}
						{{/if}}
				</p>
				{{#if showEstimate}}
				...
				{{else}}
					...
					<div class="cart-summary-total">
						<p class="cart-summary-grid-float">
							...
							<span class="cart-summary-amount-text">
