<div class="columnscct-column-container">
    <div class="columnscct-img-container">{{#if hasImage}}<img class="columnscct-img" src="{{image}}" alt="{{alt}}"  title="{{title}}" />{{/if}}</div>
    ...
    <div class="columnscct-button-container">
        <a href="{{buttonLink}}" class="columnscct-button" target="{{target}}">{{buttonText}}</a>
    </div>
    {{/if}}
</div>