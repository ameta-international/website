...
function buildTemplateContextFor(file)
{
	...
	var shoppingStarter = context.distro.tasksConfig.javascript.filter(e => e.exportFile == 'shopping.js')[0].entryPoint;
	var myAccountStarter = context.distro.tasksConfig.javascript.filter(e => e.exportFile == 'myaccount.js')[0].entryPoint;
	var checkoutStarter = context.distro.tasksConfig.javascript.filter(e => e.exportFile == 'checkout.js')[0].entryPoint;
